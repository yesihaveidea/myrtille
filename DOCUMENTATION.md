...
- Myrtille doesn't support the mouse pointer shadow; this is a FreeRDP 0.8.2 issue (it may have been fixed since). An easy workaround is to disable it (Configuration panel > Hardware > Mouse > Pointers).
